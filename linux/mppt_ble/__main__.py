...
async def _cmd_serve(args: argparse.Namespace) -> int:
    ...
    async def handle_status(request: web.Request) -> web.Response:
        ...
        snap["thresholds"] = {
            ...
            "minDeltaV": min_voc_gap_v(reset_state, now, policy),
            "minVocBusMult": policy.local_mpp_min_voc_bus_mult,
            ...
            "gapMarginV": gap_margin_v(reset_state, now, policy),
            "gapMarginFrac": policy.local_mpp_gap_margin_frac,
