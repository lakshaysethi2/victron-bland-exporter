...
<div class="wrap">
  ...
  <p class="hint">Panel is GATT 0xEDBB (same as VictronConnect). Out is the bus into the next MPPT, not the cells. Auto-pulse when the 2 min average gap is near the 2h Voc gap and watts are below this hour’s envelope. At most {n} auto-pulses per hour (15 min apart). Secret stays in this tab only.</p>
</div>
<script>
(function () {{
